...
class qbehaviour_auc_responses_renderer extends qbehaviour_renderer {
    ...
    public function feedback(question_attempt $qa, question_display_options $options) {
        ...
        // If not, then make sure that previously selected distractors remain disabled
        if (
            ...
            // As long as question has not been answered correctly, make sure that "Next page" button
            // remains disabled:
        ...
        // If an answer has been selected, ensure that Feedback and "Try Again" Button are shown:
        $attributes = [
            'type' => 'submit',
